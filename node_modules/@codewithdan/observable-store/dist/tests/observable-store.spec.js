...
describe('Observable Store', function () {
    ...
    describe('getStateSliceProperty', function () {
        it('should retrieve single user property from slice when string property name passed', function () {
            ...
            var userName = userStore.getStateSliceProperty('name');
    ...
    describe('isInitialized', function () {
        it('should return false when ObservableStore state has not yet been initialized', function () {
            expect(observable_store_1.ObservableStore.isStoreInitialized).toEqual(false);
        });
        it('should return true when ObservableStore state has been initialized', function () {
            var state = {
                number: 420,
                awesome: false,
            };
            expect(observable_store_1.ObservableStore.isStoreInitialized).toEqual(false);
            observable_store_1.ObservableStore.initializeState(state);
            expect(observable_store_1.ObservableStore.isStoreInitialized).toEqual(true);
        });
        it('should return false after the ObservableStore state has been initialized and then reset', function () {
            var state = {
                number: 69,
                awesome: true,
            };
