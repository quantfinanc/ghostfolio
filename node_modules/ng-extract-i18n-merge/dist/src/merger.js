...
class Merger {
    ...
    mergeWithMapping(destFileContent, isSourceLang) {
        ...
        const result = new translationFileModels_1.TranslationFile([...destFileContent.units], destFileContent.sourceLang, destFileContent.targetLang, destFileContent.xmlHeader, destFileContent.trailingWhitespace);
    ...
    handle(unit, destUnit, isSourceLang, removeNodes) {
        ...
        if (destUnit) {
            ...
            if (this.normalize(destUnit.source) !== this.normalize(unit.source)) {
                ...
                const onlyWhitespaceChanged = ((_a = this.options.collapseWhitespace) !== null && _a !== void 0 ? _a : true) && unit.source.trim() === destUnit.source.trim();
                let target;
            ...
            return {
                ...unit,
                target: this.options.newTranslationTargetsBlank === 'omit' ? undefined : (((_b = this.options.newTranslationTargetsBlank) !== null && _b !== void 0 ? _b : false) && !isSourceLang ? '' : unit.source),
